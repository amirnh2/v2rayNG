...
import com.pix2ray.ang.dto.V2rayConfig.OutboundBean.OutSettingsBean.*
import com.pix2ray.ang.dto.V2rayConfig.OutboundBean.OutSettingsBean.VnextBean.*
    ...
    data class OutboundBean(
        ...
        data class StreamSettingsBean(
            ...
            fun populateTransportSettings(
                ...
                authority: String?, uaddress: String?, uport: Int?
            ): String? {
                var sni: String? = null
                network = transport
                when (network) {
                    ...
                    "splithttp" -> {
                        ...
                        splithttpSetting.uaddress = uaddress.orEmpty()
                        splithttpSetting.uport = uport
                ...
                return when (transport) {
                    ...
                    "splithttp" -> {
                        ...
                        listOf(
                            ...
                            splithttpSetting.uaddress,
                            splithttpSetting.uport?.toString().orEmpty()
                        )
                    }
